...
This study covered the design, development, and initial acceptability evaluation of the E-Health for All telemedicine platform for Barangay Panicuason Rural Health Unit in Naga City, Camarines Sur. The prototype included digital patient health profiles, clinical encounter documentation, vital signs monitoring, medication tracking, appointment booking, automated scheduling, virtual consultation, offline synchronization, prescription scanning, a patient portal, and an integrated health worker database. The 13 health facility personnel 7 Health Workers, 1 Midwife, 1 Encoder, 1 BNS, 1 SFV, 1 CBRS, and 1 BSWA served as respondents through total enumeration. The system was built using PHP, HTML, CSS, and JavaScript with a Supabase cloud database, compatible with Windows, macOS, Linux, Android, and iOS devices.

The study was delimited to Barangay Panicuason only and did not cover other healthcare facilities, long-term performance, cost-effectiveness, laboratory integration, payment and billing, or pharmacy management. External factors such as internet instability, power interruptions, and varying digital literacy levels were outside the scope of this study.
...
\indent A total of 13 health facility personnel completed the survey questionnaire during the data-gathering phase. Table 3.1 presents the demographic profile of the respondents.
...
\begin{table}[H]
    ...
    \begin{tabular}{lcc}
        ...
        \hspace{1em} 25 -- 34 years old    & 4 & 30.8\% \\
        \hspace{1em} 35 -- 44 years old    & 6 & 46.2\% \\
...
\indent Research Question 2 asked: ``What are the challenges encountered in the current system?'' Table 3.3 presents the weighted mean scores for each challenge indicator.
...
\begin{figure}[H]
     \caption*{Appendices A-10}
    \centering
    \includegraphics[width=0.95\textwidth]{10}
\end{figure}

\begin{figure}[H]
    \caption*{Appendices A-11}
    \centering
    \includegraphics[width=0.95\textwidth]{11}
\end{figure}
